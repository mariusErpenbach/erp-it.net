...
const DatenschutzPage = () => {
  ...
  <p>Stand: 9. April 2025</p>
  <h2>Inhaltsübersicht</h2>{" "}
  <ul className="index">
    <li>
      <Link className="index-link" href="#m4158">
        Präambel
      </Link>
    </li>
    <li>
    ...
    <li>
      <Link className="index-link" href="#m2427">
    ...
    <li>
      <Link className="index-link" href="#m134">
        Einsatz von Cookies
      </Link>
    </li>
    <li>
      <Link className="index-link" href="#m104">
    ...
    <li>
      <Link className="index-link" href="#m17">
        Newsletter und elektronische Benachrichtigungen
      </Link>
    </li>
    <li>
      <Link className="index-link" href="#m638">
        Werbliche Kommunikation via E-Mail, Post, Fax oder Telefon
      </Link>
    </li>
    <li>
      <Link className="index-link" href="#m263">
  ...
  <p>
    Marius Erpenbach
    <br />
    Joseph-Pannenbecker-Str 17
    <br />
    41515 Grevenbroich
  </p>
  <p>E-Mail-Adresse: kontakt@erp-it.net</p>
  <p>Impressum: erp-it.net/impressum</p>
  ...
  <p>
    ...
    laufender Vertragsverhältnisse, in deren Rahmen Daten gespeichert werden,
    ist das fristauslösende Ereignis der Zeitpunkt des Wirksamwerdens der
  ...
  <ul className="m-elements">
    <li>
      ...
      <Link href="https://business.safety.google/adsservices/" target="_blank">
  ...
  <ul className="m-elements">
    <li>
      ...
      ; <strong>Grundlage Drittlandtransfers:</strong> Data Privacy Framework
      (DPF), Standardvertragsklauseln (
      <Link href="https://legal.linkedin.com/dpa" target="_blank">
